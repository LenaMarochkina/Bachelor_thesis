...
# test_predictions <- predict(, test_data, type = "class")
#test_probabilities <- predict(, test_data, type = "prob")[, 2]

# Call the function with predictions and probabilities
# print_metrics(, test_data, test_probabilities, test_predictions)
