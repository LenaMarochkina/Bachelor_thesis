...
rm(final_result, predictors, hematology_death_outcome_last, test_result, auc_value, param, predictor)
```
...
rm(final_result, predictors, hematology_death_outcome_mean, test_result, auc_value, param, predictor)
```
