...
unique_labels_list <- hematology %>%
  ...
  filter(LABEL %in% c("HEMATOCRIT", "PLATELET COUNT", "WHITE BLOOD CELLS", "HEMOGLOBIN", 
                      ...
                      "SEDIMENTATION RATE", "D-DIMER")) %>%  # Convert LABEL to character
  pull(LABEL) %>%
  as.list()
...
- Hemoglobin and Hematocrit, calculated correlation is equal to 1
...
data <- data.frame(
  Predictor = c(
    ...
    "Blood Gas", "HEMOGLOBIN", "BASE_EXCESS", "FREE_CALCIUM", "LACTATE", "PCO2", "PH", "PO2", "POTASSIUM_WHOLE_BLOOD", "SODIUM_WHOLE_BLOOD", "CHLORIDE_WHOLE_BLOOD", "GLUCOSE", "PEEP", "TEMPERATURE", "OXYGEN", "OXYGEN_SATURATION", "TIDAL_VOLUME", "VENTILATION_RATE", "CALCULATED_BICARBONATE_WHOLE_BLOOD", "O2_FLOW", "METHEMOGLOBIN", "CARBOXYHEMOGLOBIN",
    "Hematology", "HEMOGLOBIN", "INR_PT", "LYMPHOCYTES", "MCH", "MCHC", "MCV", "MONOCYTES", "NEUTROPHILS", "EOSINOPHILS", "PLATELET_COUNT", "PTT", "RDW", "WHITE_BLOOD_CELLS", "FIBRINOGEN_FUNCTIONAL", "BASOPHILS", "SEDIMENTATION_RATE", "RETICULOCYTE_COUNT_AUTOMATED", "D_DIMER"
  ),
  Death_Status = c("", "+", "+", "+", "+", "+", "+", "+", "", "+", "+", "+", 
                   "", "+", "-", "+", "+", "+",
                   "", "+", "+", "+",
